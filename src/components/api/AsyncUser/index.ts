...
export const getUser = createAsyncThunk<UserType, number, { rejectValue: string }>(
    ...
    async function (id, {rejectWithValue}) {
        const response = await fetch(`http://edsokolov-001-site1.atempurl.com/api/User/${id}`)
...
export const changeBio = createAsyncThunk<UserType, {id: number, data: AboutDataType}, { rejectValue: any }>(
    ...
    async function ({id, data}, {rejectWithValue}) {
        ...
        const response = await fetch(`http://edsokolov-001-site1.atempurl.com/api/User/${id}/about`, {
            method: 'POST',
            headers: {},
            body: formData
        })
...
export const newAvatar = createAsyncThunk<UserType, {id: number, data: AboutDataType}, { rejectValue: any }>(
    ...
    async function ({id, data}, {rejectWithValue}) {
        ...
        const response = await fetch(`http://edsokolov-001-site1.atempurl.com/api/User/${id}/avatar`, {
            method: 'POST',
            headers: {},
            body: formData
        })
